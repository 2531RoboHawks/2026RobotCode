...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration().withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                .withStatorCurrentLimit(Amps.of(Constants.Swerve.kDriveCurrentLimit))
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                // stator current limit to help avoid brownouts without impacting performance.
                .withStatorCurrentLimit(Amps.of(Constants.Swerve.kSteerCurrentLimit))
                .withStatorCurrentLimitEnable(true)
        );
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.099365234375);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.406494140625);
